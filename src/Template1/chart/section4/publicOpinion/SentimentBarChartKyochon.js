...
const SentimentBarChartKyochon = () => {
  ...
  const originalData = [
    { positive: 8, negative: 28, neutral: 20 },
    { positive: 8, negative: 12.35, neutral: 35 },
    { positive: 8, negative: 28, neutral: 20 },
    { positive: 8, negative: 28, neutral: 20 },
    { positive: 8, negative: 28, neutral: 20 },
    { positive: 8, negative: 28, neutral: 20 },
    ...
    plugins: {
      ...
      datalabels: {
        ...
        formatter: (value, context) => {
          ...
          if (datasetIndex === 0) return '8%'; // 긍정
          if (datasetIndex === 1) {
            // 부정
            if (dataIndex === 1) return '12.35%';
            return '28%';
          }
          if (datasetIndex === 2) {
            // 중립
            if (dataIndex === 1) return '35%';
            return '20%';
          }
          return '';
        },
...
export default SentimentBarChartKyochon; 